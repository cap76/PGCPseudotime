...
l2 = importdata('./Monocle_allprocesses.txt')
%l2 = importdata('./Monocle_allprocesses_pgc.txt')
%l3 = importdata('./Monocle_allprocesses_soma.txt')
...
T1(inds2) = l2.data(:,end-1); 
%T2(inds3) = l3.data(:,end-1); 
