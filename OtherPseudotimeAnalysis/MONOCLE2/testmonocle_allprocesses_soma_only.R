...
ind <- which(HSMM_sample_sheet$Type != 1)

HSMM_expr_matrix  <- HSMM_expr_matrix[,ind]
HSMM_sample_sheet <- HSMM_sample_sheet[ind,]
...
write.table(as.data.frame(meh), "~/Desktop/Monocle_allprocesses_soma.txt", sep="\t")
