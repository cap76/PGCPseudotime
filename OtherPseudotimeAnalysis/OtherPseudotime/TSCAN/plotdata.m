...
l2 = importdata('./TSCAN_Pseudotime_time_PGC_reverse.csv')
l3 = importdata('./TSCAN_Pseudotime_time_soma.csv')
...
for i = 1:length(l2.data)
    inds2(i,1) = find(strcmp(l2.textdata{i+1,1}, D1.textdata(1,2:end))==1);
end

for i = 1:length(l3.data)
    inds3(i,1) = find(strcmp(l3.textdata{i+1,1}, D1.textdata(1,2:end))==1);
end
