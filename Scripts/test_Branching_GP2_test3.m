function [Dist Lout] = test_Branching_GP2_test3(seed,plt);

%Asses accuracy of B/RGPs on a correlated dataset with no branching
...
%Generate inidial hyperparams
u = log(rand(6,1));
hyp.cov = [4;0.5;0.5;-4;0.5;0.5;u];
hyp.mean = mean(X(:,1));
hyp.lik = log(0.2);

%Fit branching recombination process
