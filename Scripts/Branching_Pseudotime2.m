function Output = Branching_Pseudotime2(seed,missingT);
...
try
load(['Marker_Pseudotime_' num2str(seed) '_' num2str(missingT) '_2E_final2.mat'])
   %sdasdasd load(['~/Desktop/BranchingGPs/results/primordial_germ_cells/Pseudotime/Marker_Pseudotime_' num2str(seed) '_' num2str(missingT) '_2E.mat'])
...
for i = StartNo:NoMCMC   
 ...
 a = rand(1,1);
   ...
   % else        
	...
	save(['Marker_Pseudotime_' num2str(seed) '_' num2str(missingT) '_2E_final2.mat'],'Output')
...
D1.data = D1.data(:,ind_obs); %REMOVE ESCS
